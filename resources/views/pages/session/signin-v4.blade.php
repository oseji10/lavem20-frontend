            ...
            <div class="card-body p-0">
                <div class="row m-0">
                    <div class="col-md-6 d-flex justify-content-center p-xxl">
                        <img class="" src="{{  asset('images/illustrations/lighthouse.svg')}}">
                    </div>
                    <div class="col-md-6 gray-200 pt-xxl">
                        ...
                        <div class="d-flex align-items-center">
                            <button type="button" class="btn btn-raised btn-raised-primary mr-md">Sign In</button>
