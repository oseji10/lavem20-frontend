...
<div class="sidebar-panel">
    ...
    <div class="brand"><img src="{{asset('images/egret.png')}}" alt="" /><span
            class="app-logo-text ml-2 text-20">EGRET</span></div>

    <!-- Start:: user-->
    <div class="scroll-nav" data-perfect-scrollbar="" data-suppress-scroll-x="true">
        <div class="app-user text-center">
            <div class="app-user-photo"><img src="{{asset('images/faces/1.jpg')}}" alt="" /></div>
            <div class="app-user-info"><span class="app-user-name">Watson Joyce</span>
                <div class="app-user-control"><a class="control-item" href="#"><i class="material-icons">
                            ...
                            email</i></a><a class="control-item" href="#"><i class="material-icons">
                            exit_to_app</i></a></div>
            </div>
        </div>
        <!-- End:: user-->
                ...
                <nav class="sidebar-nav">
                    <ul class="metismenu show-on-load" id="ul-menu">
                        <li class=" {{ Request::is('dashboard/*') ? 'mm-active' : '' }}"><a class="has-arrow"
                                href="#"><i class="material-icons nav-icon">dashboard</i>Dashboards</a>
                        ...
                        <li class="{{ Request::is('pages/*') ? 'mm-active' : '' }}"><a class="has-arrow" href="#"><i
                                    class="material-icons nav-icon">web_asset</i>Pages</a>
                            <ul class="mm-collapse">
                                <li class="{{ Request::is('pages/faq/*') ? 'mm-active' : '' }}"><a class="has-arrow"
                                        href="#"><i class="material-icons nav-icon">feedback</i>FAQ</a>
                                    <ul class="mm-collapse">
                                ...
                                <li class="{{ Request::is('pages/list/*') ? 'mm-active' : '' }}"><a class="has-arrow"
                                        href="#"><i class="material-icons nav-icon">list</i>List</a>
                                    <ul class="mm-collapse">
                                ...
                                <li class="{{ Request::is('pages/pricing/*') ? 'mm-active' : '' }}"><a class="has-arrow"
                                        href="#"><i class="material-icons nav-icon">monetization_on</i>Pricing</a>
                                    <ul class="mm-collapse">
                                ...
                                <li class="{{ Request::is('pages/invoice/*') ? 'mm-active' : '' }}"><a class="has-arrow"
                                        href="#"><i class="material-icons nav-icon">all_inbox</i>Invoice</a>
                                    <ul class="mm-collapse">
                                ...
                                <li class="{{ Request::is('pages/profile/*') ? 'mm-active' : '' }}"><a class="has-arrow"
                                        href="#"><i class="material-icons nav-icon">person</i>Profile</a>
                                    <ul class="mm-collapse">
                                ...
                                <li class="{{ Route::currentRouteName()=='drag-and-drop' ? 'mm-active' : '' }}">
                                    <a href="{{route('drag-and-drop')}}"><i
                                            class="material-icons nav-icon">open_with</i>Drag &amp; Drop</a>
                                </li>
                                <li class="{{ Route::currentRouteName()=='photo-grid' ? 'mm-active' : '' }}">
                                    <a href="{{route('photo-grid')}}"><i
                                            class="material-icons nav-icon">open_with</i>Photo Grid</a></li>
                                <li class="{{ Request::is('pages/session/*') ? 'mm-active' : '' }}"><a class="has-arrow"
                                        href="#"><i class="material-icons nav-icon">settings_applications</i>Session</a>
                                    <ul class="mm-collapse">
                        ...
                        <li class="{{ Request::is('apps/*') ? 'mm-active' : '' }}"><a class="has-arrow" href="#"><i
                                    class="material-icons nav-icon">web</i>Apps</a>
                            <ul class="mm-collapse">
                                <li class="{{ Route::currentRouteName()=='note' ? 'mm-active' : '' }}">
                                    <a href="{{route('note')}}"><i class="material-icons nav-icon">book</i>Note</a>
                                </li>
                                <li class="{{ Route::currentRouteName()=='file-manager' ? 'mm-active' : '' }}">
                                    <a href="{{route('file-manager')}}"><i class="material-icons nav-icon">save</i>File
                                        Manager</a></li>
                                <li class="{{ Route::currentRouteName()=='inbox' ? 'mm-active' : '' }}">
                                    <a href="{{route('inbox')}}"><i
                                            class="material-icons nav-icon">all_inbox</i>Inbox</a>
                                </li>
                                <li class="{{ Route::currentRouteName()=='scrumboard' ? 'mm-active' : '' }}">
                                    <a href="{{route('scrumboard')}}"><i
                                            class="material-icons nav-icon">all_inbox</i>Scrumboard</a></li>
                                <li class="{{ Route::currentRouteName()=='chat' ? 'mm-active' : '' }}">
                                    <a href="{{route('chat')}}"><i class="material-icons nav-icon">chat</i>Chat</a>
                                </li>
                            </ul>
                        </li>
                        <li class="{{ Request::is('blocks/*') ? 'mm-active' : '' }}"><a class="has-arrow" href="#"><i
                                    class="material-icons nav-icon">view_array</i>Blocks</a>
                            <ul class="mm-collapse">
                        ...
                        <li class="{{ Request::is('components/*') ? 'mm-active' : '' }}"><a class="has-arrow"
                                href="#"><i class="material-icons nav-icon">settings_input_component</i>Components</a>
                            <ul class="mm-collapse">
                        ...
                        <li class="{{ Request::is('form-widgets/*') ? 'mm-active' : '' }}"><a class="has-arrow"
                                href="#"><i class="material-icons nav-icon">text_format</i>Form
                                Widgets</a>
                            <ul class="mm-collapse">
                        ...
                        <li class="{{ Request::is('widgets/*') ? 'mm-active' : '' }}"><a class="has-arrow" href="#"><i
                                    class="material-icons nav-icon">widgets</i>Widgets</a>
                            <ul class="mm-collapse">
                        ...
                        {{-- <li><a class="has-arrow" href="#"><i
                                    class="material-icons nav-icon">table_chart</i>DataTables</a>
                            <ul class="mm-collapse">
                        ...
                        <li class="{{ Route::currentRouteName()=='colors' ? 'mm-active' : '' }}">
                            <a href="{{route('colors')}}"><i
                                    class="material-icons nav-icon text-16">color_lens</i>Colors</a></li>
                        ...
                        <li class="{{ Route::currentRouteName()=='typography' ? 'mm-active' : '' }}">
                            <a href="{{route('typography')}}"><i
                                    class="material-icons nav-icon text-16">text_fields</i>Typography</a></li>
                    </ul>
                </nav>
            </div>
        </div>
