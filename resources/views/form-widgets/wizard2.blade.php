...
<div class="card">
  <div class="card-body">
    <div class="row">
      <div class="col-12 col-lg-5 mb-md ul-wizard-border-v3-right">
        <div class="multisteps-form__progress border-0">
        ...
        <div class="ul-wizard-setup-account mb-xxxl text-center">
          <h4 class="text-gray-700 mb-xl">Setup Your Account</h4>
          <p class="text-muted font-weight-normal">To start off, please enter your username, email address and
            password.</p>
        </div>
        <div class="ul-wizard-v3-img"><img src="assets/images/illustrations/pricing/undraw_setup.svg" alt="" /></div>
      </div>
      <div class="col-12 col-lg-7">
        <form class="multisteps-form__form">
          <!-- single form panel-->
          <div class="multisteps-form__panel p-4 rounded bg-white js-active" data-animation="scaleIn">
            <h3 class="multisteps-form__title">Your Information </h3>
              ...
              <div class="row">
                ...
                <div class="col-12 col-md-6 mt-4">
                  <div class="card shadow-sm">
                    <div class="card-body">
                      <h5 class="card-title">Item Title</h5>
                      <p class="card-text">Small and nice item description</p><a class="btn btn-link btn-link-dark"
                        href="#" title="Item Link">Item Link</a>
                    </div>
                  </div>
                </div>
