...
var Layout3 = (function () {
  var initLayout3 = function () {
    ...
    secondarySidebarLayoutButton.addEventListener("click", function () {
      ULUtil.hasClass(mainContentWrap3, "close-secondary-sidebar")
        ? ULUtil.removeClass(mainContentWrap3, "close-secondary-sidebar")
        : ULUtil.addClass(mainContentWrap3, "close-secondary-sidebar");
      ULUtil.hasClass(subheader, "close-secondary-sidebar")
        ? ULUtil.removeClass(subheader, "close-secondary-sidebar")
        : ULUtil.addClass(subheader, "close-secondary-sidebar");
    });
  };
  return {
    init: function () {
